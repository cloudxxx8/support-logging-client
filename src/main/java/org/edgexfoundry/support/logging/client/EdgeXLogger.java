...
public class EdgeXLogger {
	...
	//LOGGER is used internally to log all informative messages relating to EdgeXLogger implementation
	private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(EdgeXLogger.class);
	...
	private void invokeAsyncRestLogging(LogEntry logEntry){
		...
		ListenableFuture<ResponseEntity<Long>> futureEntity = 
				asyncRestClient.postForEntity(EdgeXLoggerPropertyHolder.getLoggingServiceURL(), entity, Long.class);
		
		// register a callback for asynchronous invocation
		futureEntity.addCallback(
			new ListenableFutureCallback<ResponseEntity<Long>>() {
	...
	public List<LogEntry> query(MatchCriteria criteria){
		//TODO implement query stuff
		return null;
	}
	
	public int delete(MatchCriteria criteria){
		//TODO implement delete stuff
		return 0;
	}
	...
	//following methods are simply offered by org.slf4j.Logger and would delegate to slf4jLoffer internally.
